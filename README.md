...
## Environments
- Preview: https://main--uni-eds--AdityaA135.aem.page/
- Live: https://main--uni-eds--AdityaA135.aem.live/
...
1. Open the `uni-eds` directory in your favorite IDE and start coding :)
